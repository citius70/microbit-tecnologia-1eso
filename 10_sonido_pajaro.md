...
* **Modo Silencio:** Haz que el sonido solo empiece a sonar si mantienes pulsado el **Botón A**. ¡Así tendrás un interruptor para tu instrumento!

---

**¿Te gustaría que hiciéramos un tutorial para crear una "Guitarra de Aire" usando la Micro:bit y un poco de cartón?**
